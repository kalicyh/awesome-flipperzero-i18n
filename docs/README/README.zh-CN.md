...
<details>
  <summary><a href="#databases--dumps">数据库 & Dumps</a></summary>
...
<details>
  <summary><a href="#applications--plugins">应用 & 插件</a></summary>
...
<details>
  <summary><a href="#firmwares--tweaks">固件 & 调整</a></summary>

  - [官方固件（ofw）](#official-firmware-ofw)
  - [自定义固件（cfw）](#custom-firmware-cfw)
  - [过时/未维护的固件](#outdatedunmaintained-firmware)

</details>
<details>
  <summary><a href="#graphics--animations">图形 & 动画</a></summary>

  - [教程](#tutorials)
  - [预制动画](#pre-made-animations)
  - [工具](#utilities)

</details>
<details>
  <summary><a href="#modules--cases">模块 & 外壳</a></summary>
...
<details>
  <summary><a href="#off-device--debugging">设备外 & 调试</a></summary>
...
<details>
  <summary><a href="#notes--references">笔记 & 参考</a></summary>

  - [拆解/维修](#disassemblyrepair)
  - [指南](#guides)
  - [规格](#specifications)
  - [其他](#other-2)
...
- [`Flipper Zero Animation Process` Talking Sasquach 提供的逐步指南 Google 文档。](https://docs.google.com/document/d/e/2PACX-1vR_nZRakD6iwJVQS8Pf4y7Wm4klcucrC7EKVO8m_DQV63To7e-alqD0yaoO3sTygjcChfcRo80Hdeet/pub)
...
- [`Flipper-Zero-Backpacks` 带有ESP32、Raspberry Pi、原型板等的背包附加板。](https://github.com/Chrismettal/flipper-zero-backpacks)
...
- [`FlipperScripts` 修改你的海豚的状态和级别。](https://github.com/DroomOne/FlipperScripts)
