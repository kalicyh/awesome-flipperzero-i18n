...
<details>
  <summary><a href="#databases--dumps">Базы данных & Дамп</a></summary>
...
<details>
  <summary><a href="#applications--plugins">Приложения & Плагины</a></summary>

- [Общие](#general-1)
- [Sub-GHz](#sub-ghz-1)
- [Инфракрасные](#infrared-1)
- [BadUSB](#badusb-1)
- [GPIO](#gpio)
- [Bluetooth](#bluetooth)
- [Игры](#games)
- [Утилиты/Другое](#utilityother)

</details>
<details>
  <summary><a href="#firmwares--tweaks">Прошивки & Настройки</a></summary>

- [Официальная прошивка (ofw)](#official-firmware-ofw)
- [Пользовательская прошивка (cfw)](#custom-firmware-cfw)
- [Устаревшие/Необслуживаемые прошивки](#outdatedunmaintained-firmware)

</details>
<details>
  <summary><a href="#graphics--animations">Графика & Анимации</a></summary>

- [Учебники](#tutorials)
- [Предустановленные анимации](#pre-made-animations)
- [Инструменты](#utilities)

</details>
<details>
  <summary><a href="#modules--cases">Модули & Корпуса</a></summary>
...
<details>
  <summary><a href="#off-device--debugging">Вне устройства & Отладка</a></summary>
...
<details>
  <summary><a href="#notes--references">Заметки & Ссылки</a></summary>

- [Разбор/ремонт](#disassemblyrepair)
- [Руководства](#guides)
...
- [`Официальная прошивка` Официальная прошивка Flipper Zero.](https://github.com/flipperdevices/flipperzero-firmware)
